...
class PATH_CONFIGS:
    ...
    """
    def __init__(self): 
        self.e4e = 'pretrained/utils/e4e_ffhq_encode.pt'
        self.stylegan2_ada_ffhq = 'pretrained/ffhq.pkl'
        self.ir_se50 = 'pretrained/utils/model_ir_se50.pth'
        self.dlib = 'pretrained/utils/shape_predictor_68_face_landmarks.dat'
